# Lista de Exercicios da Unidade 3.1 do curso de Projeto de construção de algoritmos

Este repositório contém uma lista de exercícios desenvolvidos em **Python**, utilizando **Programação Orientada a Objetos (POO)**.
...
```
python Cursos/PCA/3.1/exercicios/nome_do_arquivo.py
```

Exemplo:

```
python Cursos/PCA/3.1/exercicios/exercicio1.py
```
